...
popProfile <- function(popdata, country, baseYear, compYear){
      ...
      popProfile <- rbind(popProfile, 
                          data.frame(feature="Total Population (thousands)", 
                                     baseYear=as.character(as.integer(baseSum)),
                                     thisYear=as.character(as.integer(thisSum)),
                                     compYear=as.character(as.integer(compSum))),
                          data.frame(feature="Sex Ratio (Males:Females)",
                                     baseYear=paste(as.character(as.integer(popSums$sexRatio[popSums$Year==baseYear])),":","100", sep=""),
                                     thisYear=paste(as.character(as.integer(popSums$sexRatio[popSums$Year==thisYear])),":","100", sep=""),
                                     compYear=paste(as.character(as.integer(popSums$sexRatio[popSums$Year==compYear])),":","100", sep="")),
