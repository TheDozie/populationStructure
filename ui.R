...
shinyUI(fluidPage(
      ...
      sidebarLayout(
            ...
            sidebarPanel(
                  ...
                  hr(),
                  strong("Please be patient when you change country and we have to read data from the web, which might take SEVERAL minutes - and I really mean SEVERAL minutes"),
                  br(),
                  strong("... but after that it works pretty well"),
                  hr(),
                  selectInput("country", 
